...
<!--                $.ajax(-->
<!--                        './assets/js/php/json2xml.php',-->
<!--                        {-->
<!--                            success: function(data) {-->
<!--                                var datas = new Blob([data], {type: 'text/xml'});-->
...
<div id="wrapper">
    ...
    <div class="content-page">
        ...
        <div class="content dasboard-content">
                            ...
                            <div class="col-sm">
                                <div class="float-right d-none d-md-block">
                                    <div class="button-items">
                                        <button class="btn btn-primary" onclick="location.href = 'downloadxml.html';" id="export_button" type="button"
                                                data-toggle="button" style="margin-top: 0;">
            ...
            <div class="row" id="row-reload">
                <div class="col-xl-6">
                    <div class="card messages">
                        <div class="card-body">
                            <h4 class="mt-0 header-title mb-4">Top 10 temperaturen per 10 seconden</h4>
                ...
                <div class="col-xl-6">
                    <div class="card messages">
                        <div class="card-body">
                            <h4 class="mt-0 header-title mb-4">Top 10 regenval per 10 seconden</h4>
                            <div class="table-rep-plugin">
                                <div class="table-responsive mb-0" data-pattern="priority-columns">
                                    <table id="tech-companies-1" class="table table-striped">
                                        <thead>
                                        <tr>
                                            <th>Station</th>
                                            <th data-priority="1">Regenval (mm)</th>
                                        </tr>
                                        </thead>
                                        <tbody id="data-rain">
