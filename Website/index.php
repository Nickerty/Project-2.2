...
<div id="wrapper">
    ...
    <script>
        function download() {
            $.getJSON("/json/tbl_name.json", function downloadxml(json) {
                var jsonload = json;
                var c = json2xml(jsonload);
                var hiddenElement = document.createElement('a');
                hiddenElement.href = 'data:text/xml;charset=utf-8,' + encodeURI(c);
                hiddenElement.target = '_blank';
                hiddenElement.download = 'test.xml';
                hiddenElement.click();
            });
                            ...
                            <div class="col-sm">
                                <div class="float-right d-none d-md-block">
                                    <div class="button-items">
                                        <button class="btn btn-primary" type="button" onclick="download()" id="export_button" data-toggle="button"
                                                style="margin-top: 0;">
